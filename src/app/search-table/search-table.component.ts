...
export class SearchTableComponent implements OnChanges, OnInit {
  ...
  delete(obj) {
    ...
    this.http.delete("http://localhost:8080/tour/api/ver01/vvt/company/" + id, {
      headers,
    });
...
*/
  ...
  saveNewRecordTODB(inputJson) {
    ...
    this.http
      .post<any>(
        "http://localhost:8080/tour/api/ver01/vvt/company",
        inputJson,
        { headers }
      )
      .subscribe((data) => {
  ...
  modifyRecordTODB(inputJson) {
    ...
    this.http
      .post<any>(
        "http://localhost:8080/tour/api/ver01/vvt/company/update",
        inputJson,
        { headers }
      )
      .subscribe((data) => {
